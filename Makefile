...
build/kernel.bin: $(ASM_OBJ) $(CPP_OBJ)
	x86_64-elf-objcopy -O elf64-x86-64 -B i386 -I binary res/zap-ext-light20.psf $(OBJ_DIR)/zap-ext-light20.o
	x86_64-elf-ld -n -T linker.ld $(CPP_OBJ) $(ASM_OBJ) $(OBJ_DIR)/zap-ext-light20.o -o build/kernel.bin
